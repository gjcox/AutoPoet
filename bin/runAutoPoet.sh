...
# javac --module-source-path module-name="$JAVAFX_DIR"javafx.media -cp "$CLASSPATH" gui/AutoPoet.java -d "$DIRM"
javac --module-path "$JAVAFX_DIR" --add-modules javafx.media,javafx.fxml,javafx.controls -cp "$CLASSPATH" */*.java 
